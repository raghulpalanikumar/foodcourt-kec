...
const hdProducts = [
    ...
    },
    {
        ...
        price: 55,
        category: 'breakfast',
        image: 'https://images.unsplash.com/photo-1630138356828-912b704c7760?auto=format&fit=crop&w=800&q=80',
        isVeg: true
    },
    {
    ...
    },
    {
        ...
        price: 50,
        category: 'juices',
        image: 'https://images.unsplash.com/photo-1615474472254-e1b732483561?auto=format&fit=crop&w=800&q=80',
        isVeg: true
    },
    {
    ...
    // --- BIRYANI ---
    {
        ...
        description: 'Our signature dum-cooked basmati rice layered with melt-in-the-mouth chicken and saffron.',
        price: 180,
        category: 'biryani',
...
async function seedHDProducts() {
    try {
        ...
        // We take a clean approach to avoid duplicates if names changed slightly
        ...
        for (const p of hdProducts) {
            ...
            console.log(`✨ Synced HD Item: ${p.name} [${p.category}]`);
        }
